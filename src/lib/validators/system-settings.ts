...
export const systemSettingsSchema = z.object({
  ...
  allowAiAssistantInRestrictedModes: z.boolean().optional(),
  allowStandaloneCompilerInRestrictedModes: z.boolean().optional(),
  ...
  autoCodeReviewEnabled: z.boolean().optional(),
