...
- **Status:** role-create conflict handling and recruiting-invitation duplicate-email races are now robust; additional role/member/invite mutation paths still need revalidation or fixes.
