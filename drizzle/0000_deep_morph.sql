...
CREATE UNIQUE INDEX `pga_problem_group_idx` ON `problem_group_access` (`problem_id`,`group_id`);--> statement-breakpoint
...
CREATE UNIQUE INDEX `psga_problem_set_group_idx` ON `problem_set_group_access` (`problem_set_id`,`group_id`);--> statement-breakpoint
...
CREATE UNIQUE INDEX `psp_problem_set_problem_idx` ON `problem_set_problems` (`problem_set_id`,`problem_id`);--> statement-breakpoint
...
CREATE TABLE `problems` (
	...
	`show_compile_output` integer DEFAULT true NOT NULL,
	`show_detailed_results` integer DEFAULT true NOT NULL,
	`show_runtime_errors` integer DEFAULT true NOT NULL,
	`allow_ai_assistant` integer DEFAULT true NOT NULL,
	`author_id` text,
	`created_at` integer NOT NULL,
	`updated_at` integer NOT NULL,
